...
def add_problem_options(parser, pretrain=False, no_boundaries=False, **kwargs):
    ...
    cl_protocols = ['splitMNIST', 'permMNIST', 'CIFAR10', 'CIFAR100', 'RotatedMNIST', 'dSprites']
    problem_params.add_argument('--experiment', type=str, default='CIFAR10' if pretrain else 'splitMNIST',
                             choices=['CIFAR10', 'CIFAR100', 'MNIST', 'MNIST32', 'RotatedMNIST', 'dSprites'] if pretrain else cl_protocols)
    if no_boundaries:
